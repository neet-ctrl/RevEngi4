...
.method static B(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/g;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 6
    ...
    .line 150
    invoke-virtual {p1}, Lj$/time/zone/b;->I()Lj$/time/ZoneOffset;
...
.method static I(Lj$/time/chrono/l;Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/k;
    ...
    invoke-static {v1, v2, p1, v0}, Lj$/time/LocalDateTime;->h0(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
...
.method static r(Lj$/time/chrono/l;Lj$/time/temporal/l;)Lj$/time/chrono/k;
    .locals 3
...
.method public final H(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-static {p1, v1, v0}, Lj$/time/chrono/k;->B(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/g;)Lj$/time/chrono/ChronoZonedDateTime;
...
.method public final b(JLj$/time/temporal/q;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    .line 294
    invoke-virtual {v4, p1, p2, p3}, Lj$/time/chrono/g;->V(JLj$/time/temporal/q;)Lj$/time/chrono/g;

    move-result-object p1

    iget-object p2, p0, Lj$/time/chrono/k;->b:Lj$/time/ZoneOffset;

    invoke-static {v3, p2, p1}, Lj$/time/chrono/k;->B(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/g;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    .line 453
    invoke-interface {v4, p1}, Lj$/time/chrono/e;->X(Lj$/time/ZoneOffset;)J
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/k;->d(JLj$/time/temporal/t;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-static {v0, p1}, Lj$/time/chrono/k;->r(Lj$/time/chrono/l;Lj$/time/temporal/l;)Lj$/time/chrono/k;
...
.method public final d(JLj$/time/temporal/t;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/chrono/g;->I(JLj$/time/temporal/t;)Lj$/time/chrono/g;

    move-result-object p1

    invoke-interface {p0, p1}, Lj$/time/chrono/ChronoZonedDateTime;->m(Lj$/time/temporal/m;)Lj$/time/chrono/ChronoZonedDateTime;
