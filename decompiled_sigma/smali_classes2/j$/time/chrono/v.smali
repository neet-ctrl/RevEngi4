...
.method public final T(Lj$/time/temporal/a;)Lj$/time/temporal/v;
    .locals 4
...
.method final V(Ljava/util/Map;Lj$/time/format/y;)Lj$/time/chrono/b;
    ...
    .line 447
    invoke-virtual {p0, v1}, Lj$/time/chrono/v;->T(Lj$/time/temporal/a;)Lj$/time/temporal/v;
    ...
    invoke-virtual {v4, v5, v6, v1}, Lj$/time/temporal/v;->a(JLj$/time/temporal/q;)I
    ...
    .line 452
    invoke-virtual {p0, v4}, Lj$/time/chrono/v;->T(Lj$/time/temporal/a;)Lj$/time/temporal/v;
    ...
    invoke-virtual {p1, v0, v1, p2}, Lj$/time/chrono/x;->V(JLj$/time/temporal/ChronoUnit;)Lj$/time/chrono/x;

    move-result-object p1

    sget-object p2, Lj$/time/temporal/ChronoUnit;->DAYS:Lj$/time/temporal/ChronoUnit;

    invoke-virtual {p1, v2, v3, p2}, Lj$/time/chrono/x;->V(JLj$/time/temporal/ChronoUnit;)Lj$/time/chrono/x;
    ...
    .line 487
    :cond_3
    invoke-virtual {p0, v5}, Lj$/time/chrono/v;->T(Lj$/time/temporal/a;)Lj$/time/temporal/v;
    ...
    invoke-virtual {v1, v3, v4, v5}, Lj$/time/temporal/v;->a(JLj$/time/temporal/q;)I

    move-result v1

    .line 488
    invoke-virtual {p0, v8}, Lj$/time/chrono/v;->T(Lj$/time/temporal/a;)Lj$/time/temporal/v;
    ...
    invoke-virtual {v3, v4, v5, v8}, Lj$/time/temporal/v;->a(JLj$/time/temporal/q;)I
    ...
    .line 498
    invoke-virtual {p1, p2}, Lj$/time/chrono/x;->a0(Lj$/time/temporal/o;)Lj$/time/chrono/x;
    ...
    .line 519
    :cond_a
    invoke-virtual {p0, v0}, Lj$/time/chrono/v;->T(Lj$/time/temporal/a;)Lj$/time/temporal/v;
    ...
    invoke-virtual {p2, v3, v4, v0}, Lj$/time/temporal/v;->a(JLj$/time/temporal/q;)I
