...
.method public static b(Landroid/content/Context;I[Landroid/content/Intent;ILandroid/os/Bundle;Z)Landroid/app/PendingIntent;
    ...
    .line 1
    invoke-static {p5, p3}, LO/S;->a(ZI)I
...
.method public static c(Landroid/content/Context;I[Landroid/content/Intent;IZ)Landroid/app/PendingIntent;
    ...
    .line 1
    invoke-static {p4, p3}, LO/S;->a(ZI)I
...
.method public static g(Landroid/content/Context;ILandroid/content/Intent;IZ)Landroid/app/PendingIntent;
    ...
    .line 5
    invoke-static {p0, p1, p2, p3}, LO/S$b;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method public static i(Landroid/app/PendingIntent;ILandroid/app/PendingIntent$OnFinished;Landroid/os/Handler;)V
    ...
    .line 1
    new-instance v0, LO/S$d;

    .line 2
    .line 3
    invoke-direct {v0, p2}, LO/S$d;-><init>(Landroid/app/PendingIntent$OnFinished;)V

    .line 4
    .line 5
    .line 6
    :try_start_0
    invoke-virtual {v0}, LO/S$d;->c()Landroid/app/PendingIntent$OnFinished;
    ...
    .line 15
    .line 16
    invoke-virtual {v0}, LO/S$d;->close()V
...
.method public static j(Landroid/app/PendingIntent;Landroid/content/Context;ILandroid/content/Intent;Landroid/app/PendingIntent$OnFinished;Landroid/os/Handler;)V
    ...
    .line 9
    invoke-static/range {v0 .. v7}, LO/S;->k(Landroid/app/PendingIntent;Landroid/content/Context;ILandroid/content/Intent;Landroid/app/PendingIntent$OnFinished;Landroid/os/Handler;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static k(Landroid/app/PendingIntent;Landroid/content/Context;ILandroid/content/Intent;Landroid/app/PendingIntent$OnFinished;Landroid/os/Handler;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 2
    .line 3
    invoke-direct {v0, p4}, LO/S$d;-><init>(Landroid/app/PendingIntent$OnFinished;)V

    .line 4
    .line 5
    .line 6
    :try_start_0
    invoke-static/range {p0 .. p7}, LO/S$a;->a(Landroid/app/PendingIntent;Landroid/content/Context;ILandroid/content/Intent;Landroid/app/PendingIntent$OnFinished;Landroid/os/Handler;Ljava/lang/String;Landroid/os/Bundle;)V
