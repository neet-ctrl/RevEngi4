...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;LN3/h;Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-direct/range {p0 .. p6}, Landroid/support/v4/media/session/MediaSessionCompat$j;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;LN3/h;Landroid/os/Bundle;)V
...
.method public C(J)I
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$j;->C(J)I
...
.method public E(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 24
    .line 25
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$j;->E(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public S(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 5
    invoke-virtual {p1}, Landroid/support/v4/media/session/PlaybackStateCompat;->n()F
...
.method public h(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$j;->h(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
