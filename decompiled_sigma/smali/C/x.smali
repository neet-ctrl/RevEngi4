...
.method public static b(Landroid/content/Context;LC/f;Landroid/net/Uri;)V
    .locals 3
    .param p0    # Landroid/content/Context;
        .annotation build Lj/O;
        .end annotation
    ...
    .line 22
    .line 23
    invoke-virtual {p1, p0, p2}, LC/f;->t(Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static c(Landroid/content/Context;LC/m;Landroid/net/Uri;)V
    .locals 3
    .param p0    # Landroid/content/Context;
        .annotation build Lj/O;
        .end annotation
...
.method public static d(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;LC/m;)Z
    .locals 0
    .param p0    # Landroid/content/Context;
        .annotation build Lj/O;
        .end annotation
    ...
    .line 1
    invoke-static {p0, p2, p1}, LQ/f;->h(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
    ...
    .line 10
    invoke-virtual {p4, p1, p2, p0}, LC/m;->m(Landroid/net/Uri;ILandroid/os/Bundle;)Z
