...
.method private static unstableUpdateDataSourceFactory(LE1/A$b;Ljava/util/Map;Ljava/lang/String;)V
    .locals 1
    .param p0    # LE1/A$b;
        .annotation build Lj/O;
        .end annotation
    ...
    .line 1
    invoke-virtual {p0, p2}, LE1/A$b;->l(Ljava/lang/String;)LE1/A$b;
    ...
    .line 6
    invoke-virtual {p2, v0}, LE1/A$b;->d(Z)LE1/A$b;
...
.method public getMediaSourceFactory(Landroid/content/Context;)Lb2/O$a;
    ...
    invoke-virtual {p0, p1, v0}, Lio/flutter/plugins/videoplayer/HttpVideoAsset;->getMediaSourceFactory(Landroid/content/Context;LE1/A$b;)Lb2/O$a;
...
.method public getMediaSourceFactory(Landroid/content/Context;LE1/A$b;)Lb2/O$a;
    .locals 2
    ...
    invoke-static {p2, v1, v0}, Lio/flutter/plugins/videoplayer/HttpVideoAsset;->unstableUpdateDataSourceFactory(LE1/A$b;Ljava/util/Map;Ljava/lang/String;)V

    .line 5
    new-instance v0, LE1/y$a;

    invoke-direct {v0, p1, p2}, LE1/y$a;-><init>(Landroid/content/Context;LE1/p$a;)V

    .line 6
    new-instance p2, Lb2/q;

    invoke-direct {p2, p1}, Lb2/q;-><init>(Landroid/content/Context;)V

    invoke-virtual {p2, v0}, Lb2/q;->u(LE1/p$a;)Lb2/q;
