...
# direct methods
.method public constructor <init>(LH1/y;Lio/flutter/plugins/videoplayer/VideoPlayerCallbacks;Z)V
    .locals 0
    .param p1    # LH1/y;
...
.method private getRotationCorrectionFromFormat(LH1/y;)I
    .locals 0
    ...
    .line 1
    invoke-interface {p1}, LH1/y;->z1()Ly1/x;
...
.method public sendInitialized()V
    ...
    .line 2
    .line 3
    invoke-interface {v0}, Ly1/U;->w()Ly1/I1;
    ...
    .line 8
    .line 9
    iget v3, v0, Ly1/I1;->a:I

    .line 10
    .line 11
    iget v4, v0, Ly1/I1;->b:I
    ...
    .line 23
    .line 24
    invoke-direct {p0, v0}, Lio/flutter/plugins/videoplayer/texture/TextureExoPlayerEventListener;->getRotationCorrectionFromFormat(LH1/y;)I
