...
.method private static openCustomTab(Landroid/content/Context;Landroid/net/Uri;Landroid/os/Bundle;Lio/flutter/plugins/urllauncher/Messages$BrowserOptions;)Z
    ...
    .line 14
    invoke-virtual {v0, p3}, LC/f$i;->O(Z)LC/f$i;
    ...
    .line 18
    invoke-virtual {p3}, LC/f$i;->d()LC/f;
    ...
    .line 22
    iget-object v0, p3, LC/f;->a:Landroid/content/Intent;
    ...
    .line 29
    :try_start_0
    invoke-virtual {p3, p0, p1}, LC/f;->t(Landroid/content/Context;Landroid/net/Uri;)V
    :try_end_0
...
.method public supportsCustomTabs()Ljava/lang/Boolean;
    ...
    .line 7
    invoke-static {v0, v1}, LC/d;->h(Landroid/content/Context;Ljava/util/List;)Ljava/lang/String;
