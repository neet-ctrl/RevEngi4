...
.method public static createNotificationInfo(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/NotificationParams;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;
    ...
    invoke-direct {v3, p1, p3}, LO/F$n;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 15
    invoke-virtual {v3, p3}, LO/F$n;->N(Ljava/lang/CharSequence;)LO/F$n;

    .line 16
    new-instance v4, LO/F$l;

    invoke-direct {v4}, LO/F$l;-><init>()V

    invoke-virtual {v4, p3}, LO/F$l;->A(Ljava/lang/CharSequence;)LO/F$l;

    move-result-object p3

    invoke-virtual {v3, p3}, LO/F$n;->z0(LO/F$y;)LO/F$n;
    ...
    .line 20
    invoke-virtual {v3, p3}, LO/F$n;->t0(I)LO/F$n;
    ...
    .line 22
    invoke-virtual {v3, p3}, LO/F$n;->x0(Landroid/net/Uri;)LO/F$n;
    ...
    .line 24
    invoke-virtual {v3, p3}, LO/F$n;->M(Landroid/app/PendingIntent;)LO/F$n;
    ...
    .line 26
    invoke-virtual {v3, p0}, LO/F$n;->T(Landroid/app/PendingIntent;)LO/F$n;
    ...
    invoke-virtual {v3, p0}, LO/F$n;->I(I)LO/F$n;
    ...
    .line 31
    invoke-virtual {v3, p0}, LO/F$n;->C(Z)LO/F$n;
    ...
    .line 33
    invoke-virtual {v3, p0}, LO/F$n;->e0(Z)LO/F$n;
    ...
    .line 35
    invoke-virtual {v3, p0}, LO/F$n;->B0(Ljava/lang/CharSequence;)LO/F$n;
    ...
    invoke-virtual {v3, p0}, LO/F$n;->k0(I)LO/F$n;
    ...
    invoke-virtual {v3, p0}, LO/F$n;->G0(I)LO/F$n;
    ...
    invoke-virtual {v3, p0}, LO/F$n;->h0(I)LO/F$n;
    ...
    .line 43
    invoke-virtual {v3, p1}, LO/F$n;->r0(Z)LO/F$n;
    ...
    invoke-virtual {v3, p3, p4}, LO/F$n;->H0(J)LO/F$n;
    ...
    .line 46
    invoke-virtual {v3, p0}, LO/F$n;->F0([J)LO/F$n;
    ...
    invoke-virtual {v3, p4, p1, p0}, LO/F$n;->d0(III)LO/F$n;
    ...
    invoke-virtual {v3, p0}, LO/F$n;->S(I)LO/F$n;
    ...
    invoke-direct {p0, v3, p1, p3}, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;-><init>(LO/F$n;Ljava/lang/String;I)V
...
.method private static getColor(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    .line 52
    :try_start_1
    invoke-static {p0, p1}, LQ/d;->g(Landroid/content/Context;I)I
...
.method public static getOrCreateChannel(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 42
    .line 43
    invoke-static {v0, p1}, LD/e;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    .line 144
    invoke-static {p1, p0, p2}, LD/i;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;
    ...
    .line 148
    invoke-static {v0, p0}, LD/g;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
