...
.method public static F(Ljava/lang/Iterable;)Ljava/util/TreeSet;
    ...
    .line 1
    invoke-static {}, Lk5/y4;->E()Ljava/util/TreeSet;
...
.method public static H(Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 1
    new-instance v0, Lk5/y4$l;

    .line 2
    .line 3
    invoke-direct {v0, p0}, Lk5/y4$l;-><init>(Ljava/util/Set;)V
...
.method public static I(Ljava/util/Set;Ljava/util/Collection;)Z
    ...
    .line 9
    .line 10
    invoke-interface {p1}, Lk5/P3;->d()Ljava/util/Set;
    ...
    .line 32
    invoke-static {p0, p1}, Lk5/o3;->U(Ljava/util/Iterator;Ljava/util/Collection;)Z
    ...
    .line 41
    invoke-static {p0, p1}, Lk5/y4;->J(Ljava/util/Set;Ljava/util/Iterator;)Z
...
.method public static K(Ljava/util/NavigableSet;Lk5/e4;)Ljava/util/NavigableSet;
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 35
    invoke-virtual {p1}, Lk5/e4;->y()Ljava/lang/Comparable;
    ...
    .line 39
    invoke-virtual {p1}, Lk5/e4;->K()Ljava/lang/Comparable;
    ...
    .line 53
    .line 54
    invoke-static {v0, v3}, Lh5/H;->e(ZLjava/lang/Object;)V
    ...
    .line 73
    invoke-virtual {p1}, Lk5/e4;->x()Lk5/x;
    ...
    .line 88
    invoke-virtual {p1}, Lk5/e4;->J()Lk5/x;
...
.method public static L(Ljava/util/Set;Ljava/util/Set;)Lk5/y4$m;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x10,
    ...
    .line 10
    .line 11
    new-instance v0, Lk5/y4$d;

    .line 12
    .line 13
    invoke-direct {v0, p0, p1}, Lk5/y4$d;-><init>(Ljava/util/Set;Ljava/util/Set;)V
...
.method public static M(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;
    ...
    .line 1
    invoke-static {p0}, Lk5/M4;->q(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;
...
.method public static N()Ljava/util/stream/Collector;
    ...
    .line 1
    invoke-static {}, Lk5/Z0;->l0()Ljava/util/stream/Collector;
...
.method public static O(Ljava/util/Set;Ljava/util/Set;)Lk5/y4$m;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x10,
    ...
    .line 10
    .line 11
    new-instance v0, Lk5/y4$a;

    .line 12
    .line 13
    invoke-direct {v0, p0, p1}, Lk5/y4$a;-><init>(Ljava/util/Set;Ljava/util/Set;)V
...
.method public static P(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;
    ...
    .line 10
    :cond_0
    new-instance v0, Lk5/y4$o;

    .line 11
    .line 12
    invoke-direct {v0, p0}, Lk5/y4$o;-><init>(Ljava/util/NavigableSet;)V
...
.method public static a(Ljava/util/List;)Ljava/util/Set;
    ...
    .line 1
    invoke-static {p0}, Lk5/y4$f;->p3(Ljava/util/List;)Ljava/util/Set;
...
.method public static varargs b([Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 5
    invoke-static {p0}, Lk5/y4;->a(Ljava/util/List;)Ljava/util/Set;
...
.method public static c(Ljava/util/Set;I)Ljava/util/Set;
    ...
    .line 1
    invoke-static {p0}, Lk5/A3;->Q(Ljava/util/Collection;)Lk5/O2;
    ...
    .line 34
    invoke-static {p0}, Lk5/Y2;->E(Ljava/lang/Object;)Lk5/Y2;
    ...
    .line 44
    .line 45
    invoke-virtual {p0}, Lk5/O2;->r()Lk5/Y2;
    ...
    .line 54
    :cond_2
    new-instance v0, Lk5/y4$e;

    .line 55
    .line 56
    invoke-direct {v0, p1, p0}, Lk5/y4$e;-><init>(ILk5/O2;)V
...
.method public static d(Ljava/util/Collection;)Ljava/util/EnumSet;
    ...
    .line 37
    invoke-static {p0, v0}, Lk5/y4;->o(Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/EnumSet;
...
.method public static e(Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/EnumSet;
    ...
    .line 15
    :cond_0
    invoke-static {p0, p1}, Lk5/y4;->o(Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/EnumSet;
...
.method public static f(Ljava/util/Set;Ljava/util/Set;)Lk5/y4$m;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x10,
    ...
    .line 10
    .line 11
    new-instance v0, Lk5/y4$c;

    .line 12
    .line 13
    invoke-direct {v0, p0, p1}, Lk5/y4$c;-><init>(Ljava/util/Set;Ljava/util/Set;)V
...
.method public static h(Ljava/util/NavigableSet;Lh5/I;)Ljava/util/NavigableSet;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 4
    .line 5
    check-cast p0, Lk5/y4$i;

    .line 6
    .line 7
    iget-object v0, p0, Lk5/c1$a;->g0:Lh5/I;
    ...
    .line 13
    new-instance v0, Lk5/y4$h;

    .line 14
    .line 15
    iget-object p0, p0, Lk5/c1$a;->f0:Ljava/util/Collection;
    ...
    .line 18
    .line 19
    invoke-direct {v0, p0, p1}, Lk5/y4$h;-><init>(Ljava/util/NavigableSet;Lh5/I;)V
...
.method public static i(Ljava/util/Set;Lh5/I;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 6
    .line 7
    invoke-static {p0, p1}, Lk5/y4;->j(Ljava/util/SortedSet;Lh5/I;)Ljava/util/SortedSet;
    ...
    .line 29
    .line 30
    invoke-direct {v0, p0, p1}, Lk5/y4$i;-><init>(Ljava/util/Set;Lh5/I;)V
...
.method public static j(Ljava/util/SortedSet;Lh5/I;)Ljava/util/SortedSet;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 18
    .line 19
    invoke-direct {v0, p0, p1}, Lk5/y4$j;-><init>(Ljava/util/SortedSet;Lh5/I;)V
...
.method public static varargs l(Ljava/lang/Enum;[Ljava/lang/Enum;)Lk5/Y2;
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 5
    invoke-static {p0}, Lk5/L2;->O(Ljava/util/EnumSet;)Lk5/Y2;
...
.method public static m(Ljava/lang/Iterable;)Lk5/Y2;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public static n(Ljava/util/Set;Ljava/util/Set;)Lk5/y4$m;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x10,
    ...
    .line 10
    .line 11
    new-instance v0, Lk5/y4$b;

    .line 12
    .line 13
    invoke-direct {v0, p0, p1}, Lk5/y4$b;-><init>(Ljava/util/Set;Ljava/util/Set;)V
...
.method public static t(Ljava/lang/Iterable;Ljava/lang/Class;)Ljava/util/EnumSet;
    ...
    .line 5
    invoke-static {p1, p0}, Lk5/n3;->a(Ljava/util/Collection;Ljava/lang/Iterable;)Z
...
.method public static v(Ljava/lang/Iterable;)Ljava/util/HashSet;
    ...
    .line 17
    invoke-static {p0}, Lk5/y4;->w(Ljava/util/Iterator;)Ljava/util/HashSet;
...
.method public static w(Ljava/util/Iterator;)Ljava/util/HashSet;
    ...
    .line 1
    invoke-static {}, Lk5/y4;->u()Ljava/util/HashSet;
