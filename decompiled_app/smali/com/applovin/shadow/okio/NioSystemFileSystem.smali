...
.method private final zeroToNull(Ljava/nio/file/attribute/FileTime;)Ljava/lang/Long;
    ...
    .line 73
    invoke-static {p1}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/attribute/FileTime;)J
...
.method protected final metadataOrNull(Ljava/nio/file/Path;)Lcom/applovin/shadow/okio/FileMetadata;
    ...
    .line 43
    invoke-static {}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline1;->m()Ljava/nio/file/LinkOption;
    ...
    .line 40
    invoke-static {v1, v3, v5}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline2;->m(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
    ...
    .line 51
    invoke-static {v3}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline3;->m(Ljava/nio/file/attribute/BasicFileAttributes;)Z
    ...
    .line 52
    invoke-static/range {p1 .. p1}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline4;->m(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    .line 58
    invoke-static {v3}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline5;->m(Ljava/nio/file/attribute/BasicFileAttributes;)Z

    move-result v9

    .line 59
    invoke-static {v3}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline6;->m(Ljava/nio/file/attribute/BasicFileAttributes;)Z
    ...
    .line 61
    :goto_1
    invoke-static {v3}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline7;->m(Ljava/nio/file/attribute/BasicFileAttributes;)J
    ...
    .line 62
    invoke-static {v3}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline8;->m(Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/attribute/FileTime;
    ...
    .line 63
    :goto_2
    invoke-static {v3}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline9;->m(Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/attribute/FileTime;
    ...
    .line 64
    :goto_3
    invoke-static {v3}, Lcom/applovin/shadow/okio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline10;->m(Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/attribute/FileTime;
